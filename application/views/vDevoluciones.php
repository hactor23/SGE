    ...
    <div class="box box-primary" style="resize:none;">
      <div class="box-body" style="resize:none;">
          ...
          <table id="tblDevoluciones" border="1" class="table table-bordered table-striped">
          <thead>
            <tr>
      ...
      <div class="modal fade" id="modalObservacion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog modal-sm" id="modalObs" rola="document">
              <div class="modal-content">
                <div class="modal-header bg-blue">
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                     <span aria-hidden="true">&times;</span></button>
                  <h4 class="modal-title" style="text-align: center;">Observación</h4>
                </div>
                ...
                <textarea name="mtxtObs" class="form-control" disabled="true" id="mtxtObs" rows="5" cols="10" style="resize:none;"></textarea>
                </div>        
                ...
                <div class="modal-footer">
                  <button type="button" class="btn btn-default pull-left" data-dismiss="modal" id="mbtnCerrarObs">Cerrar</button>
                </div>
