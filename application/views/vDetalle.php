    ...
    <div class="box box-primary" style="resize:none;">
      <div class="box-body" style="resize:none;">
          ...
          <div class="row">
              ...
              <h4 class="col-sm-1" id="fechaRegistro">Desde: </h4> 
              <input type="date" class="col-sm-3" id="txtDesde" style="font-size: 16pt; text-align: left;">
              <h4 class="col-sm-1" id="fechaRegistro">Hasta: </h4> 
          ...
          <table id="tblRegistroImpresion" border="1" class="table table-bordered table-striped">
          <thead>
            <tr>
          ...
          <div class="form-group">
              <h3 class="col-sm-3" id="totalEfectivo">Efectivo: $0.00</h3>
              <h3 class="col-sm-3" id="totalCredito">Credito: $0.00</h3>
              <h3 class="col-sm-3" id="totalRegistro">Impresiones: $0.00</h3>
          </div>
         
      </div>    
      <h5>(*)Aclaración: el credito va a ser positivo cuando a un alumno o docente se le acredite dinero a favor y será negativo cuando se le acredite dinero que debe.</h5>
    </div>
